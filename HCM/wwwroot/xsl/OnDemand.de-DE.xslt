...
<html>
<head>
<title>DPF FullBatchService Transaction Report</title>
...
<tr>
	...
	<table cellpadding="0" cellspacing="0" width="100%" border="0">
	<tr>
		<td align="center" class="contenttitle">Einzelergebnis aus <br/> DPF FullBatchService Transaction Report / BatchID <xsl:value-of select="/Batch/Settings/batchid"/> </td>
	</tr>
	...
	<tr>
		<td class="contentitemb">gestartet am/um</td>
		<td width="10" class="contentitemb" align="center">:</td>
