...
<html>
<head>
<title>DPF RTPack Delta Transaction Report</title>
...
<tr>
	...
	<table cellpadding="0" cellspacing="0" width="100%" border="0">
	<tr>
		<td align="center" class="contenttitle">DPF RTPack Delta Transaction Report / BatchID <xsl:value-of select="/Batch/Settings/batchid"/> </td>
	</tr>
	...
	<tr>
		<td class="contentitemb">gestartet</td>
		<td width="10" class="contentitemb" align="center">:</td>
	...
	<tr>
		...
		<td width="10" class="contentitemb" align="center">:</td>
		<td  class="contentitemb"><xsl:value-of select="DominoFormat:GetDateTime(/Batch/Settings/finishedon,'g')"/></td>
	</tr>
	<tr>
		<td  class="contentitemb">Adressen insgesamt</td>
		<td width="10" class="contentitemb" align="center">:</td>
		<td  class="contentitemb"><xsl:value-of select="/Batch/Settings/totalrecords"/></td>
	</tr>
	<tr>
		<td  class="contentitemb">Anzahl Treffer</td>
		<td width="10" class="contentitemb" align="center">:</td>
		<td  class="contentitemb"><xsl:value-of select="/Batch/Settings/matchedrecord"/></td>
	</tr>	
	<tr>
		<td  class="contentitemb">Treffer insgesamt</td>
		<td width="10" class="contentitemb" align="center">:</td>
		<td  class="contentitemb"><xsl:value-of select="/Batch/Settings/totalmatches"/></td>
	</tr>
	<tr>
