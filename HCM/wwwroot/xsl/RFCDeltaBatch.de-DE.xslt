...
<tr>
	...
	<table cellpadding="0" cellspacing="0" width="100%" border="0">
	<tr>
		<td align="center" class="contenttitle">Einzelergebnis aus <br/> RFC DeltaBatchService Transaction Report / BatchID <xsl:value-of select="/Batch/Settings/batchid"/> </td>
	</tr>
