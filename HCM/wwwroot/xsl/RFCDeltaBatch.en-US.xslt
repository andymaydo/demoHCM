...
<html>
<head>
<title>RFC DeltaBatchService Transaction Report</title>
...
<tr>
	...
	<table cellpadding="0" cellspacing="0" width="100%" border="0">
	<tr>
		<td align="center" class="contenttitle">RFC DeltaBatchService single Hit-Report / BatchID <xsl:value-of select="/Batch/Settings/batchid"/> </td>
	</tr>
    ...
    <table cellpadding="0" cellspacing="0" width="540" border="0">
      ...
      <tr>
        ...
        <td  class="contentitemb">
          <xsl:choose>
            <xsl:when test="(1 = /Batch/Settings/checktypeid)">[name only]</xsl:when>
            <xsl:when test="(2 = /Batch/Settings/checktypeid)">[address only]</xsl:when>
            <xsl:when test="(3 = /Batch/Settings/checktypeid)">[name and address]</xsl:when>
            <xsl:when test="(4 = /Batch/Settings/checktypeid)">[all fields]</xsl:when>
            <xsl:otherwise>
      ...
      <tr>
        ...
        <td  class="contentitemb">
          <xsl:choose>
            <xsl:when test="(1 = /Batch/Settings/matchtypeid)">[scout about]</xsl:when>
            <xsl:when test="(2 = /Batch/Settings/matchtypeid)">[similar]</xsl:when>
            <xsl:when test="(3 = /Batch/Settings/matchtypeid)">[accurate]</xsl:when>
            <xsl:otherwise>
