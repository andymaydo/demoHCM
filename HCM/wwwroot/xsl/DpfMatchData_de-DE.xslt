          ...
          <tr>
            <td valign="top">
              ...
              <table cellpadding="0" cellspacing="0" width="100%" border="0">
                ...
                <tr>
                  <td align="center" class="contenttitle">
                    ProfilID : <xsl:value-of select="/Root/Batch/Settings/profileid"/><xsl:value-of select="/Root/Tran/Settings/profileid"/>
                  </td>
                </tr>
                </xsl:if>  
              ...
              <table cellpadding="0" cellspacing="0" width="100%" border="0">
                ...
                <tr>
                  <td class="contenttitle">Zusammenfassung</td>
                </tr>
                <tr>
                  <td width="1" height="5">
                    <DIV style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; MARGIN: 1px; PADDING-TOP: 0px"></DIV>
              ...
              <table cellpadding="0" cellspacing="0" width="440" border="0">
                ...
                <xsl:if test="((/Root/Batch/Settings/finishedon != '') or (/Root/Tran/Settings/finishedon != '') )">
                <tr>
              ...
              <table cellpadding="0" cellspacing="0" width="100%" border="0">
                ...
                <tr>
                  <td class="contenttitle">Matching Einstellungen</td>
                </tr>
                <tr>
                  <td width="1" height="5">
                    <DIV style="PADDING-RIGHT: 0px; PADDING-LEFT: 0px; PADDING-BOTTOM: 0px; MARGIN: 1px; PADDING-TOP: 0px"></DIV>
